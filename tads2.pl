...
sub generate() {
	...
	print $File_Decompiled "//Generated by version $Decompiler_Version of tads2 decompiler by Fictitious Frode\n";
...
#			}
		...
		if	($opcode eq 0x1B) {	# OPCJF				27
			...
			#			BEGIN	Destination is just past an unconditional jump forward inside current branch
			#	IF		BEGIN	Otherwise
